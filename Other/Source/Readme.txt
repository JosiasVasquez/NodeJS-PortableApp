...
user in an INI file next to NodeJSPortable.exe called NodeJSPortable.ini.
...
copy AppNamePortable.ini from this directory to NodeJSPortable.ini next to
NodeJSPortable.exe. The options in the INI file are as follows:
